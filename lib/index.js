...
;// CONCATENATED MODULE: ./node_modules/@ztwx/form/lib/validators/min.validator.js
/* harmony default export */ const min_validator = (class {
...
const appendValidator = c => {
  ...
  if (c.minLength) {
    c.validators?.push(new min_validator((c.label || "") + replaceErrText(setting.form.minLengthText, c.minLength), c.minLength));
  }
